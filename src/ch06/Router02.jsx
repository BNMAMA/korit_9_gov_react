...
function phone() {
    return <div>
        ...
        <Routes>
            ...
            <Route path="/p3" element={<h3>010-1111-5678</h3>}></Route>
...
function Name() {
    return <h1>이름이 나오는 페이지 <Link to={"/name"}>홈으로</Link></h1>
}

function Age() {
    return <h1>나이가 나오는 페이지 <Link to={"/age"}>홈으로</Link></h1>
}

function NotFound() {
    return <h1>페이지를 찾을 수 없습니다. <Link to={"/age"}>홈으로</Link></h1>
}
