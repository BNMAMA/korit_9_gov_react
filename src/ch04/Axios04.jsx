...
function Axios04() {
    ...
    const reqPostOnClick3 = () =>{
        ...
        inputElement.onchange = (e) => {
            ...
            const [file] = files;//무조건 첫번째 객체를 가지고 온다
            //input type file 에만 있는 속성
    ...
    const reqDeleteOnClick = () => { //config 안의 data에 넣어야 함
    ...
    return <>
        ...
        <button onClick={reqDeleteOnClick}>reqDelete10</button>
    </>
}
